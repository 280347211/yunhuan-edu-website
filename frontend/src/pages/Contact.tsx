    ...
    <main>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle at 60% 40%, rgba(59,130,246,0.2) 0%, transparent 50%)" }}
        />
                ...
                <Card className="h-full border-[#e2e8f0] hover:border-[#3b82f6]/30 transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    ...
                    {info.href ? (
                      <a
                        href={info.href}
                        className="text-[#1a56db] font-medium text-sm hover:underline"
                      >
                        {info.content}
                      </a>
                    ) : (
              ...
              <div className="bg-white rounded-xl border border-[#e2e8f0] p-8">
                ...
                {submitted ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <Button
                      variant="outline"
                      className="mt-6 border-[#1a56db] text-[#1a56db]"
                      onClick={() => {
                        setSubmitted(false);
                        setFormState({ name: "", phone: "", email: "", company: "", message: "" });
                      }}
                    >
                      继续留言
                    </Button>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          placeholder="请输入姓名"
                          className="border-[#e2e8f0] focus:border-[#1a56db]"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-[#0f172a] mb-1.5">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        rows={5}
                        className="border-[#e2e8f0] focus:border-[#1a56db] resize-none"
                      />
                    </div>
                    <Button
                      type="submit"
                      className="w-full text-white font-medium border-0"
